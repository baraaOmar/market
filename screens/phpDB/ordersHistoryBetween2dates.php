...
$orders = "SELECT id,`customer_name`, `phone`,  `date`,IFNULL(( `total_payed_real`) ,0)as price, IFNULL((total_payed_real-total_payed) ,0) as profit FROM `orders` WHERE orders.date BETWEEN DATE_FORMAT('$d_start','%Y-%m-%d') and DATE_FORMAT('$d_end','%Y-%m-%d')";  
